#!/bin/bash
# Checkpoint 4: Installed Boot Validation
#
...
checkpoint_header 4 "Installed Boot Validation"
...
test_command "Root is writable" "touch /tmp/.checkpoint-test && rm /tmp/.checkpoint-test"
